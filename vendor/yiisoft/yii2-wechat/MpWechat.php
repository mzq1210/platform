...
use yii\wechat\mp\Card;
use yii\wechat\mp\ShakeAround;
use yii\wechat\mp\DataCube;
use yii\wechat\mp\CustomService;
use yii\wechat\components\BaseWechat;
use yii\wechat\components\MessageCrypt;
