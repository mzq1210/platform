...
<form action="<?php echo Url::to(['/sys/dictgroup/edit/', 'id' => $info->id]) ?>" method="post" id="myform">
    <table width="100%" class="table_form contentWrap">
        <tr>
            <th width="100">组名称：</th>
            <td><input type="text" name="DictGroup[name]" value="<?= $info->name; ?>" id="name" class="input-text"></td>
        </tr>      
        <tr>
            <th>组编码：</th>
            <td><input type="text" name="DictGroup[code]" value="<?= $info->code; ?>" id="code" class="input-text"></td>
        </tr>
    </table>
